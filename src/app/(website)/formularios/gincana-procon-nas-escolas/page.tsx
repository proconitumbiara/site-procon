  ...
  return (
    <>
      <main id="main-content" role="main" aria-label="Conteúdo principal">
        <div className="container mx-auto px-4 py-6 sm:px-6 sm:py-8 lg:px-8 flex flex-col items-center">
          <Image
            src="/LogoGincanaProcon.png"
            alt="Gincana Procon nas Escolas"
            width={500}
            height={500}
            className="mx-auto h-auto max-h-48 w-auto md:mx-0 md:max-h-48"
          />
          <div className="mb-4">
